import com.cologique.scalabits.circle1.review.variance.invariant.{Employee,Manager, Award}
...
def processArray(array:Array[Award[Employee]]) = {
  ...
  array(0) = managerAward // Will not work if invariant- putting an manager award into array of Apples!
}
processArray(a)
//*/
